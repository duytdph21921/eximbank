...
const ViewExamEmpty = (props) => {
  const onHandleExplore = () => {};

  return (
    <View style={styles.viewRmpty}>
      <IconEmpty width={120} height={100} />
      <CMText i18nKey="text-empty-exam" style={styles.textEmptyClass} />
      {/* <CMText
      ...
      >
        <CMText i18nKey="text-button-explore-exam" style={styles.textBtnExplore} />
      </TouchableDebounce>
    </View>
  );
};

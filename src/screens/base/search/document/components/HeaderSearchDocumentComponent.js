...
const HeaderSearchDocumentComponent = (props) => {
  ...
  const gotoContentCategoryScreen = () => {
    navigation.navigate(Constant.CONTENT_CATEGORY_SCREEN);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <CMText style={styles.textTitleBox2} i18nKey="text-search-document" />
        <CMTextInput
          placeholder={
...
export default HeaderSearchDocumentComponent;

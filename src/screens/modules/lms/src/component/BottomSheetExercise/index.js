...
import { submitContent } from '../../services/lmsclassuserexercise.api';
import { viewDetailExercise } from '../../services/lmsclassexercise.api';
...
const RenderItemFile = ({ item, index, onHandleRemoveFile }) => (
  <View style={styles.viewItem}>
    <View style={styles.viewContent}>
      <IconFilter width={20} height={20} />
      <CMText style={styles.titleFile} title={item?.fileName} />
    </View>
    <TouchableDebounce
      onPress={() => {
...
const BottomSheetExercise = (props) => {
  ...
  const { isOpenModal, closeModal, handleApplyOnPress, idExercise } = props;
              ...
              <View style={[styles.buttonSheet]} onLayout={onViewLayout}>
                ...
                >
                  <TouchableDebounce activeOpacity={1}>
                    <RenderViewTitle i18keyContext="submit" type={1} />
                    <CMTextInput
                      ...
                      onChangeText={(enterContent) =>
                        setEnterContent(enterContent)
                      }
                      value={enterContent}
                    />
                    <TouchableDebounce onPress={getFile} style={styles.block}>
                    ...
                    >
                      <CMText i18nKey="submit" style={styles.textBtnApply} />
                    </TouchableDebounce>
                  </TouchableDebounce>
                </ScrollView>
              </View>

...
const BottomAddClassTopic = (props) => {
  const { isOpenModal, closeModal, handleSubmitTopic, item } = props;
  ...
  const onHandleSubmitTopic = () => {
    if (item) {
      const newItem = { ...item, title: enterTitle, content: enterContent };
          ...
          >
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <View style={[styles.buttonSheet]} onLayout={onViewLayout}>
                <CMText i18nKey="text-topic-class" style={styles.textHeader} />
                <CMTextInput
                  textInputStyle={styles.textInputTitle}
                  multiline={false}
                  placeholder={
                    languageLocal === Constant.LANGUAGE_VN
                      ? PLACEHOLDER.vn.placeholderTitle
                      : PLACEHOLDER.en.placeholderTitle
                  }

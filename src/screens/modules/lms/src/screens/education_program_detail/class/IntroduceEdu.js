...
import { getById } from '../../../services/lmssubject.api';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.viewDate}>
        ...
        <CMText i18nKey="text-title-type-subject" style={styles.textTime}>
          <CMText
      ...
      <View style={styles.viewDate}>
        ...
        <CMText i18nKey="text-time-subject-detail" style={styles.textTime}>
          <CMText
            title={` ${dataInfoEduProgram?.duration} `}
            style={styles.textTime}
          />
          <CMText i18nKey="text-time-subject" style={styles.textTime} />
        </CMText>
      </View>

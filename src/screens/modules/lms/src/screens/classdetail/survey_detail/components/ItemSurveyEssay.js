 ...
 * @returns
 */
const ItemSurveyEssay = ({ item, index, onHandleSelect, isDisable }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {isDisable && (
        ...
        >
          <CMText i18nKey={getKey18n()} style={styles.textSave} />
        </TouchableDebounce>
      )}
...
export default React.memo(ItemSurveyEssay, areEqual);

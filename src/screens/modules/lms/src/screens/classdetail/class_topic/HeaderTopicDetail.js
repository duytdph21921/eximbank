        ...
        {contentInfo && (
          ...
          >
            <FontAwesomeIcon
              ...
              size={10}
            />
            <CMText title={contentTitle} style={styles.textHeader} />
          </TouchableDebounce>
        )}
        <FontAwesomeIcon
          icon={faAngleRight}
          ...
          size={10}
        />
        <CMText title={title} style={styles.textHeader} />
      </View>
      <View style={styles.boxTopic}>
        {/* Tiêu đề thảo luận */}
        <View style={{ marginBottom: vertical(8) }}>
          <CMText title={topicInfo?.title} style={styles.title} />
        </View>
        {/* Thông tin người tạo thao luận */}
        <View style={styles.boxItem}>
          {classTopicInfo?.avatar ? (
            <FastImage
              source={{ uri: loadFile(classTopicInfo?.avatar) }}
              resizeMode="contain"
          ...
          <View>
            ...
            />
            <View style={[styles.boxItem, { marginLeft: horizontal(4) }]}>
              <CMText
              ...
              <CMText
                ...
                style={styles.textTime}
              />
              <CMText i18nKey="text-comment" style={styles.textTime} />
            </View>
          </View>
          {data?.isCreated && (
        ...
        {/* Hành động trong thảo luận */}
        <View style={styles.topicAction}>
          <View style={styles.boxItemInfo}>
            <View style={styles.boxItemAction}>
              <CMText
                title={(data?.totalLike ?? 0).toString()}
                style={styles.textTime}
              />
              <CMText i18nKey="text-total-like" style={styles.textTime} />
            </View>
            <View style={styles.boxItemAction}>
              <CMText
                title={(data?.totalComment ?? 0).toString()}
          ...
          <View style={styles.boxItemInfo}>
            ...
            >
              <FontAwesomeIcon
                ...
                style={[
                  styles.iconAction,
                  data?.isLiked === true && { color: Color.base_color },
                ]}
                size={24}
              />
              <CMText i18nKey="text-like" style={styles.displayName} />
            </TouchableDebounce>
            <View style={styles.boxItemAction}>
              <IconMessage width={24} height={24} />
              <CMText i18nKey="text-comments" style={styles.displayName} />
            </View>
          </View>
          <View style={styles.boxAllAction}>
            {listFileUploaded && (
              <View>
                <FastImage
                  source={{ uri: loadFile(listFileUploaded?.fileName) }}
                  resizeMode="contain"
            ...
            <View>
              <CMTextInput
                placeholder={
                  languageLocal === Constant.LANGUAGE_VN
                    ? PLACEHOLDER.vn.comment
                    : PLACEHOLDER.en.comment
                }
                returnKeyType="next"
                onSubmitEditing={() => {
                  postComment();
              ...
              />
              <View style={styles.boxActionInput} onLayout={onLayout}>
                {isEditComment && (
                  <TouchableDebounce
                    onPress={() => {
                      onCancelChange();

...
const RenderItemClassTopic = ({ item, languageLocal, viewDetailTopic }) => (
  <TouchableOpacity
...
const ClassTopicContentList = (props) => {
  const { contentInfo, classInfo, index, handleTopicInfo, handleBack } = props;
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.boxParent}>
          <FlatList
            ...
            ListEmptyComponent={<ViewClassTopicEmpty />}
          />
        </View>

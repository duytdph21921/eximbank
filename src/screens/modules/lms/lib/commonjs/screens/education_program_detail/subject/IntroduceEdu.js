...
const IntroduceEdu = props => {
  ...
  const funcGetById = async () => {
    const response = await (0, _lmstrainingApi.getById)(id);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_CustomImage.default, {
      ...
      children: [(dataInfoEduProgram?.startDate !== '' || dataInfoEduProgram?.endDate !== '') && /*#__PURE__*/(0, _jsxRuntime.jsx)(_icon_watch.default, {
        width: 18,
        height: 18
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_CMText.default, {
...
const styles = _reactNative.StyleSheet.create({
  ...
  viewLine: {
    ...
    marginVertical: (0, _scales.vertical)(24)
  }
});

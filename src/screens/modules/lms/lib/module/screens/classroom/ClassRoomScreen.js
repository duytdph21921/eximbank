...
import BottomSheetFilterClassRoom from "../../component/BottomSheetFilterClassRoom/index.js";
import { getClassJoined } from "../../services/lmsclass.api.js";
import { styles } from "./ClassRoom.styles.js";
import HeaderClassRoomComponent from "./components/HeaderClassRoomComponent.js";
import ViewClassRoomEmpty from "./components/ViewClassRoomEmpty.js";
...
const ClassRoomScreen = props => {
  ...
  const handleLoadMore = () => {
    if (!isLoadMore && !this.onEndReachedCalledDuringMomentum && listClassRoom.length < countContent) {
      setLoadMore(true);
      const newModel = {
        ...model,
        offset: offset + limit
   ...
   * @param {*} param0
   */
  const renderItemClassRoom = item => /*#__PURE__*/_jsxs(TouchableDebounce, {
  ...
  const RenderBottomFilter = useCallback(() => /*#__PURE__*/_jsx(BottomSheetFilterClassRoom, {
  ...
  return /*#__PURE__*/_jsx(KeyboardAvoidingView, {
    ...
    children: /*#__PURE__*/_jsxs(SafeAreaView, {
      ...
      children: [/*#__PURE__*/_jsx(FlatList, {
        ...
        ListHeaderComponent: /*#__PURE__*/_jsx(HeaderClassRoomComponent, {
        ...
        ListEmptyComponent: /*#__PURE__*/_jsx(ViewClassRoomEmpty, {
          onPressExplore: () => {
            gotoSearchClass();
          }
        })

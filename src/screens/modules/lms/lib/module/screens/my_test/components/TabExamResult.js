...
import { startTestMobile } from "../../../services/testclassusertest.api.js";
import { jsx as _jsx, jsxs as _jsxs } from "react/jsx-runtime";
const RenderButtonFooter = (onHandleEnterExam, isCurrentTestStatus, i18nKey) => /*#__PURE__*/_jsx(TouchableDebounce, {
  style: [styles.btnEnterExam, {
    backgroundColor: Color.base_color
  }],
  onPress: onHandleEnterExam,
  disabled: isCurrentTestStatus === Constant.MY_TEST_STATUS.notStart || isCurrentTestStatus === Constant.MY_TEST_STATUS.finished || isCurrentTestStatus === Constant.MY_TEST_STATUS.overLimit,
...
const TabExamResult = props => {
   ...
   * @returns
   */
  const itemResult = item => /*#__PURE__*/_jsxs(TouchableDebounce, {
    style: [styles.viewItem],
    onPress: () => onPressGoMyTestResult(item),
    children: [/*#__PURE__*/_jsx(View, {
      style: [styles.viewIcon, {
        backgroundColor: item?.mark >= dataInformation?.mincore ? Color.color_pass : Color.color_not_pass
      }],
      children: item?.mark >= dataInformation?.mincore ? /*#__PURE__*/_jsx(IconCheck, {
        width: 20,
        height: 20
      }) : /*#__PURE__*/_jsx(IconCancel, {
        width: 20,
        height: 20
      })
    }), /*#__PURE__*/_jsxs(View, {
      ...
      children: [/*#__PURE__*/_jsx(CMText, {
        ...
        children: dataInformation?.showMark && /*#__PURE__*/_jsx(CMText, {
    ...
    }), dataInformation?.showResultAll === true && /*#__PURE__*/_jsx(IconNext, {
      width: 18,
      height: 18
    })]
  });
  ...
  return /*#__PURE__*/_jsx(View, {
    children: (dataInformation?.showResultAll === true || dataInformation?.showMark === true) && /*#__PURE__*/_jsxs(View, {
      ...
      }), /*#__PURE__*/_jsx(RenderButtonFooter, {

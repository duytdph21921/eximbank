...
import { frGetById } from "../../../services/lmsclasscontent.api.js";
import { updateLastState } from "../../../services/lmsclassuserlearning.api.js";
...
const ViewContentScreen = props => {
  ...
  useEffect(() => {
    ...
    if (learning?.id && !classInfo?.isCloseClass && !classInfo?.isNotStartClass) {
      const socketUrl = `${storage.getString(Constant.DOMAIN)}${enviroment.apiDomain.lrsEndpoint}?learningId=${learning?.id}`;
  ...
  return /*#__PURE__*/_jsxs(SafeAreaView, {
    ...
    children: [classContent && classContent.typeId === GetTypeContent.audio && /*#__PURE__*/_jsx(ViewPlayAudio, {
      fileId: classContent.fileId
    }), classContent && classContent.typeId === GetTypeContent.document && /*#__PURE__*/_jsx(ViewDocument, {
      fileId: classContent.fileId
    }), classContent && classContent.typeId === GetTypeContent.video && /*#__PURE__*/_jsx(View, {
      style: styles.video,
      children: /*#__PURE__*/_jsx(ViewVideo, {
        fileId: classContent.fileId,
    ...
    }), classContent && classContent.typeId === GetTypeContent.scorm && /*#__PURE__*/_jsx(ViewScorm, {
      fileId: classContent.fileId,
      learningId: learning?.id,
      username: username,
      ...
      navigation: navigation,
      handleRouteScreen: handleRouteScreen
    }), classContent && classContent.typeId === GetTypeContent.tincam && /*#__PURE__*/_jsx(ViewTincan, {
      fileId: classContent.fileId,
      learningId: learning?.id,
      username: username,
      contentId: classContent?.id,
      ...
      navigation: navigation,
      handleRouteScreen: handleRouteScreen
    }), classContent && classContent.typeId !== GetTypeContent.audio && classContent.typeId !== GetTypeContent.document && classContent.typeId !== GetTypeContent.video && classContent.typeId !== GetTypeContent.scorm && classContent.typeId !== GetTypeContent.tincam && /*#__PURE__*/_jsx(ViewContent, {

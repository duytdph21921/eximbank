...
const ClassTopicGeneral = props => {
  ...
  const handleLoadMore = () => {
    if (!isLoadMore && !this.onEndReachedCalledDuringMomentum && listData.length < total) {
      setLoadMore(true);
      // getData(newModel);
      this.onEndReachedCalledDuringMomentum = true;
    }
  };
  const renderItemClassTopic = item => /*#__PURE__*/_jsxs(TouchableOpacity, {
  ...
  return /*#__PURE__*/_jsx(SafeAreaView, {
    ...
    children: isViewDetail === false ? /*#__PURE__*/_jsxs(View, {
      style: {
        flex: 1
      },
      children: [/*#__PURE__*/_jsx(View, {

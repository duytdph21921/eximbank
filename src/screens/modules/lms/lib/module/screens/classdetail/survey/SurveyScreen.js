...
import { updateLoadingAction, updateParamsSurveyScreenAction, updateShowDialogWarnAction } from '@store/reducers/globalSlice';
...
import { getDetail, saveUser } from "../../../services/lmssurvey.api.js";
import { styles } from "./SurveyScreen.styles.js";
/**
...
const SurveyScreen = props => {
  ...
  const paramsSurveyScreen = useSelector(state => state.global.paramsSurveyScreen);
  ...
  const funcGetDetail = async (id, newClassId) => {
    ...
    if (response?.status && isMounteRef.current) {
      ...
      dispatch(updateParamsSurveyScreenAction({
  ...
  return /*#__PURE__*/_jsx(SafeAreaView, {
    ...
    children: /*#__PURE__*/_jsxs(ScrollView, {
      ...
      children: [/*#__PURE__*/_jsx(IconSurvey, {
        width: 67,
        height: 67

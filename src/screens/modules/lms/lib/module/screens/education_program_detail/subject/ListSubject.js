...
import { getByTrainingId } from "../../../services/lmssubject.api.js";
...
const ListSubject = props => {
   ...
   * @param {*} param0
   */
  const renderItemSubject = item => /*#__PURE__*/_jsxs(TouchableDebounce, {
    ...
    children: [/*#__PURE__*/_jsx(CustomImage, {
      ...
      children: [/*#__PURE__*/_jsx(IconField, {
        width: 18,
        height: 18
      }), /*#__PURE__*/_jsx(CMText, {
  ...
  const renderHeader = () => /*#__PURE__*/_jsx(View, {

...
import { KeyboardAvoidingView, RefreshControl, SafeAreaView, View, VirtualizedList } from 'react-native';
...
import ViewMyTestEmpty from "./components/ViewMyTestEmpty.js";
import ViewHeader from "./components/ViewHeader.js";
import RenderHeaderList from "./components/RenderHeaderList.js";
import RenderItemTest from "./components/RenderItemTest.js";
import { getMyTest } from "../../services/testregistortestform.api.js";
import BottomSheetFilterMyTestSearch from "../../component/BottomSheetFilterMyTestSearch/index.js";
...
const MyTestScreen = props => {
  ...
  const handleLoadMore = () => {
    if (!isLoadMore && !this.onEndReachedCalledDuringMomentum && listMyTest?.length < totalRecord) {
      setLoadMore(true);
      const newModel = {
        ...model,
        offset: offset + limit
  ...
  const RenderBottomFilter = useCallback(() => /*#__PURE__*/_jsx(BottomSheetFilterMyTestSearch, {
  ...
  return /*#__PURE__*/_jsx(KeyboardAvoidingView, {
    ...
    children: /*#__PURE__*/_jsxs(SafeAreaView, {
      style: styles.container,
      children: [/*#__PURE__*/_jsx(ViewHeader, {
        ...
        data: listMyTest,
        ListHeaderComponent: /*#__PURE__*/_jsx(RenderHeaderList, {
          onPressFilter: () => {
            setIsOpenModal(true);
          },
        ...
        renderItem: ({
          item,
          index
        }) => /*#__PURE__*/_jsx(RenderItemTest, {
          item: item,
          index: index,
          navigation: navigation
        }),
        contentContainerStyle: styles.contentContainerStyle,
        ListEmptyComponent: /*#__PURE__*/_jsx(ViewMyTestEmpty, {
          onHandleExplore: () => {
            onPressExplore();
          }
        })

...
const RenderItemTest = (props) => {
  ...
  return (
    <TouchableDebounce style={styles.container} onPress={onHandleItem}>
      <View
        style={[
          styles.viewIcon,
          {
      ...
      <View style={styles.viewContent}>
        ...
        <View style={styles.viewItem}>
          <IconMark width={16} height={16} />
          <CMText style={styles.textContentItem} i18nKey="text-title-marks" />
          <CMText
            title={`${item?.minMark}`}
            numberOfLines={1}
            style={[
        ...
        <View style={styles.viewItem}>
          ...
          <CMText style={styles.textContentItem} i18nKey="text-title-exam" />
          <CMText

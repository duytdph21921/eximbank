...
import { logoutAction, updateLoadingAction, updateShowDialogWarnAction } from '@store/reducers/globalSlice';
import BackHeader from '@components/BackHeader';
import { hasNotch } from 'react-native-device-info';
import { resetUserAction } from '@store/reducers/authSlice';
import { storage } from '@utils/storage';
import { deleteMe, userChangePassword } from "../../services/authentication/authenticationusers.api.js";
...
const ProfileChangePasswordScreen = props => {
  ...
  return /*#__PURE__*/_jsx(KeyboardAvoidingView, {
    ...
    children: /*#__PURE__*/_jsxs(SafeAreaView, {
      ...
      }), isShowPopup && /*#__PURE__*/_jsx(DialogWarnCustom, {
...
export default /*#__PURE__*/React.memo(ProfileChangePasswordScreen);

...
import { register } from "../../services/hr/hrprofile.api.js";
import { authenticationUsers } from "../profile/model/authenticationusers.model.js";
import { styles } from "./RegisterScreen.style.js";
import Agree from "./component/Agree.js";
import FooterRegister from "./component/Footer.js";
    ...
    children: /*#__PURE__*/_jsx(SafeAreaView, {
      ...
      children: /*#__PURE__*/_jsxs(ScrollView, {
        ...
        children: [/*#__PURE__*/_jsx(Header, {
          ...
          placeholder: languageLocal === Constant.LANGUAGE_VN ? PLACEHOLDER.vn.emailplaceholder : PLACEHOLDER.en.emailplaceholder,
          inputRef: refEmail,
          returnKeyType: "next",
          ...
          style: [styles.btnLogin, {
            backgroundColor: checkEmptyRequired() ? Color.base_color : Color.color_border
          }],
          ...
          children: /*#__PURE__*/_jsx(CMText, {
            ...
            style: [styles.textBtnLogin, {
              color: checkEmptyRequired() ? Color.white : Color.color_unactive
            }]
          })
        }), /*#__PURE__*/_jsx(FooterRegister, {
...
export default /*#__PURE__*/React.memo(RegisterScreen);

 ...
 * @returns
 */
const ItemQuestionMultiple = (props) => {
  /**
  ...
  // console.log("itemQuestion 2:   " + JSON.stringify(itemQuestion));
...
export default ItemQuestionMultiple;

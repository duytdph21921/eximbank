...
import { getSettingBiometric, updateBiometricUser } from "../../../services/authentication/authenticationusers.api.js";
...
const ProtectAccountScreen = props => {
  ...
  const onPressSwitch = () => {
    const textNotifi = '';
    TouchID.authenticate(textNotifi, optionalConfigObject).then(success => {
      if (success) {
...
export default /*#__PURE__*/React.memo(ProtectAccountScreen);
